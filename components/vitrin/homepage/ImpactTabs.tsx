...
const TABS: Tab[] = [
  ...
  },
  {
    ...
    description:
      "Madencilik faaliyetleri sonucunda doğal yapısı bozulmuş sahaların restorasyon süreçlerini hızlandırıyoruz. İHA ve optimize edilmiş tohum topu metodolojileriyle bozulmuş arazilerde vejetasyon başarısını artırıyor; kademeli ve sürdürülebilir bir orman ekosistemi kuruyoruz.",
    bullets: [
      "Uzaktan algılama + yapay zekâ ile bozulmuş arazi analizi",
      "Sıfır saha tahribatı, minimum çevresel ayak izi",
      "Kademeli ve bilimsel ekosistem yenilenmesi",
    ],
    stat: "Sıfır",
  ...
  },
  {
    ...
    Icon: AtomIcon,
    title: "Markanıza Özel Drone Destekli Karbon Nötr Orman",
    description:
      "Kurumsal panelinizde ESG yazılımınızla API entegrasyonu sağlayarak veri akışını otomatik hale getiriyoruz. Sistemimiz şirketinizin karbon ayak izini hesaplar ve bu doğrultuda markanıza özel, drone teknolojisiyle desteklenen bir orman oluştururuz.",
    bullets: [
      "Şirket karbon ayak izi hesaplaması — otomatik",
