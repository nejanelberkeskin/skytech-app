...
export type PaymentOutcome =
  | { ok: true; status: "success"; paymentId: string; paidKurus: number; meta: Record<string, unknown> }
...
export interface PaymentProvider {
  ...
  refund(input: { paymentId: string; amountKurus: number; orderNo: string }): Promise<RefundResult>;
}
